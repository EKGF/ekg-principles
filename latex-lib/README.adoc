...
Or take for instance the EKG/Principles repository at https://github.com/EKGF/ekg-principles, you should however import
such a content repo under the /mnt directory (mnt stands for "mount", analogous to
mounting a file system in Unix), see the `--prefix` option below.
...
[source,asciidoc]
----
git remote add -f ekg-principles https://github.com/EKGF/ekg-principles.git &&
git subtree add --prefix=mnt/ekg-principles --squash ekg-principles/main
----
...
[source,asciidoc]
----
git remote add -f ekg-principles git@github.com:EKGF/ekg-principles.git &&
git subtree add --prefix=mnt/ekg-principles --squash ekg-principles/main
----
...
[source,asciidoc]
----
git subtree push --prefix=mnt/ekg-principles ekg-principles main
----
...
[source,asciidoc]
----
git fetch ekg-principles && git subtree pull --prefix=mnt/ekg-principles ekg-principles main --squash
----
